...
for(const k in pts){
  ...
  const ic=L.divIcon({className:'',html:'<div style="background:'+colors[k]+';color:#fff;padding:2px 6px;border-radius:3px;font:bold 12px sans-serif;white-space:nowrap;cursor:pointer">'+k+'</div>',iconAnchor:[0,12]});
