...
| Asset | Control | Source |
|---|---|---|
| Vulnerability disclosure | Generated `security.txt` Contact + Expires + Preferred-Languages (D-T5.1 Option A; GHSA deferred to first-report trigger) | WKCC dataset `site.yaml`; rendered to `static/security.txt` |
...
| 2027-04-01 | Refresh WKCC dataset `security_expires` to 2028-05-20 (+1 year) | D-T4.5 |
