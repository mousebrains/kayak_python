...
25 ORM-defined tables plus the `schema_migrations` bookkeeping table (26 live). The ER diagram in [`schema-overview.svg`](schema-overview.svg) is auto-generated by `scripts/regenerate_schema_svg.sh` from `src/kayak/db/models.py`; regenerate after any structural change. Between regenerations the SVG can drift — when in doubt, trust this document and `sqlite3 $DB .schema`.
