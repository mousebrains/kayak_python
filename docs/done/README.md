...
| `PLAN_kalama_licor_gauge.md` | Replace the Kalama Italian-Cr calc gauge with the real LI-COR sensor; engine #210 + kayak_data #67/#69 merged 2026-06-21 (prod deploy pending) |
