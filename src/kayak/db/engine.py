...
def _set_sqlite_pragma(dbapi_conn: object, _connection_record: object) -> None:
    ...
    mmap_size + cache_size are sized for the 2 GB Hetzner CPX11:
      ...
      - cache_size=-16000 (16 MB): page cache per connection. Pipeline runs
        ...
        is ~160 MB — acceptable on the 2 GB box; a 4 GB swap file
        (deploy/SETUP.md §15) absorbs transient spikes.
    """
