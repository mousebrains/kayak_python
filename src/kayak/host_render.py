...
``docs/done/PLAN_4c_renderers.md`` for the full classification.
...
def render_cutover_dropins(h: HostConfig) -> list[CutoverDropIn]:
    ...
    for name, args, extra_env, write_paths in specs:
        ...
        lines = [
            ...
            "# re-render from host.yaml. See docs/done/PLAN_4c_renderers.md.",
            "[Service]",
            "ExecStart=",
...
def engine_unit_names() -> list[str]:
    ...
    list — see docs/done/PLAN_4c_renderers.md (D-CONSUMER).
    """
