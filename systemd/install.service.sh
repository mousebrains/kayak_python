...
TIMERS=(kayak-pipeline.timer kayak-decimate.timer kayak-editor-retention.timer kayak-backup.timer kayak-heartbeat.timer kayak-healthcheck.timer kayak-audit-gauges.timer)
